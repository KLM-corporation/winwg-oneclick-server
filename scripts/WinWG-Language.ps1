...
function Get-WinWGText([string]$Language, [string]$Key) {
    $texts = @{
        fr = @{
            ...
            SwitchToIPv6Endpoint = 'Basculer en mode IPv6 automatique pour les configs appareil'
            ...
            IPv6EndpointModeEnabled = 'Mode endpoint IPv6 active'
            ...
            ReimportDeviceConfigsWarning = 'Important : les appareils deja ajoutes doivent reimporter le .conf ou rescanner un QR regenere.'
        ...
        en = @{
            ...
            SwitchToIPv6Endpoint = 'Switch to automatic IPv6 mode for device configs'
            ...
            IPv6EndpointModeEnabled = 'IPv6 endpoint mode enabled'
            ...
            ReimportDeviceConfigsWarning = 'Important: already-added devices must reimport the .conf or rescan a regenerated QR code.'
