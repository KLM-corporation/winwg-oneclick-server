...
function Get-WinWGText([string]$Language, [string]$Key) {
    $texts = @{
        fr = @{
            ...
            AdvancedConfirmPhrase = 'JE COMPRENDS'
            ...
            Cancel = 'Annuler'
            GenerateQrTitle = 'Generer un QR code WireGuard'
            SingleDeviceDetected = 'Un seul appareil detecte'
            TypeNumberOrExactName = 'Tape le numero de l''appareil, ou son nom exact'
            RemoveDeviceTitle = 'Supprimer un appareil'
            SingleDeviceAuto = 'Un seul appareil est configure. Selection automatique'
            ...
            DnsPrompt = 'DNS pour cet appareil'
            KeepDefault = 'laisse vide pour garder cette valeur'
            ...
            DeviceAddedFinal = 'Appareil ajoute'
            ConfGeneratedIn = 'Fichier .conf genere dans'
            QrGeneratedFor = 'QR code genere pour'
            AskGenerateQrForDevice = 'Generer un QR code pour cet appareil ?'
            QrSkippedForDevice = 'QR code non genere pour cet appareil.'
        ...
        en = @{
            ...
            AdvancedEnablePrompt = 'To enable, type exactly I UNDERSTAND'
            AdvancedConfirmPhrase = 'I UNDERSTAND'
            ...
            Cancel = 'Cancel'
            GenerateQrTitle = 'Generate a WireGuard QR code'
            SingleDeviceDetected = 'Single device detected'
            TypeNumberOrExactName = 'Type the device number, or its exact name'
            RemoveDeviceTitle = 'Remove a device'
            SingleDeviceAuto = 'Only one device is configured. Automatic selection'
            ...
            DnsPrompt = 'DNS for this device'
            KeepDefault = 'leave empty to keep this value'
            ...
            DeviceAddedFinal = 'Device added'
            ConfGeneratedIn = '.conf file generated in'
            QrGeneratedFor = 'QR code generated for'
            AskGenerateQrForDevice = 'Generate a QR code for this device?'
            QrSkippedForDevice = 'QR code not generated for this device.'
